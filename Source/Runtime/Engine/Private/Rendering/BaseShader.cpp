 ...
 * On draw sprite
 */
void le::BaseShader::OnDrawSprite( IRHI* InRHI, const FVector2D& InSize, const FSRectFloat& InTextureRect, const FVector3D& InPosition, FCameraComponentConstRef& InCameraComponent )
{
