...
namespace le
{
	...
	public:
		...
		virtual void							Resize( UInt32_t NewWidth, UInt32_t NewHeight, bool IsSaveData = false );
		...
		virtual const StudioRenderSampler&		GetSampler() const;	
	...
	private:
		void				ApplySampler( const StudioRenderSampler& Sampler );
