...
/* Set value vec2 */
extern void							MaterialProxyVar_SetValueVec2( materialProxyVar_t Object, vec2_t Value );

/* Set value vec3 */
extern void							MaterialProxyVar_SetValueVec3( materialProxyVar_t Object, vec3_t Value );

/* Set value vec4 */
extern void							MaterialProxyVar_SetValueVec4( materialProxyVar_t Object, vec4_t Value );
...
extern void							MaterialProxyVar_SetValueArrayVec2( materialProxyVar_t Object, vec2_t* Array, uint32_t Count );

/* Set value array vec3 */
extern void							MaterialProxyVar_SetValueArrayVec3( materialProxyVar_t Object, vec3_t* Array, uint32_t Count );

/* Set value array vec4 */
extern void							MaterialProxyVar_SetValueArrayVec4( materialProxyVar_t Object, vec4_t* Array, uint32_t Count );
...
/* Get value vec2 */
extern vec2_t						MaterialProxyVar_GetValueVec2( materialProxyVar_t Object );

/* Get value vec3 */
extern vec3_t						MaterialProxyVar_GetValueVec3( materialProxyVar_t Object );

/* Get value vec4 */
extern vec4_t						MaterialProxyVar_GetValueVec4( materialProxyVar_t Object );
...
extern vec2_t*						MaterialProxyVar_GetValueArrayVec2( materialProxyVar_t Object, uint32_t* Count );

/* Get value array vec3 */
extern vec3_t*						MaterialProxyVar_GetValueArrayVec3( materialProxyVar_t Object, uint32_t* Count );

/* Get value array vec4 */
extern vec4_t*						MaterialProxyVar_GetValueArrayVec4( materialProxyVar_t Object, uint32_t* Count );
